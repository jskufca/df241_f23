...
And we will write a compressed copy using vroom:

```{r eval=FALSE, include=FALSE}
vroom::vroom_write(dfc,here("data","bot_flight_2017_2023m08.csv.bz2"))
```
...
```{r eval=FALSE, include=FALSE}
dfc=read_csv(here("data","bot_flight_2017_2023m08.csv"))
```

```{r}
dfc=read_csv(here("data","bot_flight_2017_2023m08.csv.bz2"))
```
